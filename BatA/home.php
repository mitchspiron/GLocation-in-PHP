...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li style="margin-left: -45px;margin-right: 20px;margin-top: 10px;"><input type="button" class="btn btn-default btn-sm" value="Rechercher" style="background-color: #cccccc;"></li>
            <li class="dropdown active"><a class="dropdown-toggle" data-toggle="dropdown" href="#"><span class="glyphicon glyphicon-user"></span> Locataires <span class="caret"></span></a>
              <ul class="dropdown-menu">
                <li><a href="#">Bâtiment A</a></li>
          ...
          <tr>
            <?php
              ...
              if(isset($_POST['search'])){
                ...
                $sql = "SELECT * FROM donnee WHERE Nom LIKE '%$searchkey%' OR Studio LIKE '%$searchkey%' OR Univ LIKE '%$searchkey%'";
              }else{
...
<footer class="navbar navbar-inverse" style="margin-top: -20px;">
    <center><p style="margin-left: 60px;margin-top:15px;color: grey;cursor: pointer;"> Liste des locataires en bâtiment A</p></center>
</footer>
