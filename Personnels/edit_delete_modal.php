    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background: #003329;">
                ...
                <center><h4 class="modal-title" id="myModalLabel" style="color: white;">Modifier la formulaire des personnels</h4></center>
            </div>
			...
			<form method="POST" action="edit.php">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Naissance:</label>
					</div>
					<div class="col-sm-10">
						<input type="text" class="form-control" name="Naissance" value="<?php echo $row['Naissance']; ?>">
					</div>
				</div>
				<div class="row form-group">
					<div class="col-sm-2">
				...
				<div class="row form-group">
					<div class="col-sm-2">
						<label class="control-label modal-label">Poste occupée:</label>
					</div>
					<div class="col-sm-10">
...
<div class="modal fade" id="delete_<?php echo $row['id']; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">	
            	<p class="text-center">Etes-vous sûre de vouloir retirer ce personnel ?</p>
