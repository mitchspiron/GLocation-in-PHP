          ...
          <tr>
            <?php
              ...
              if(isset($_POST['search'])){
                ...
                $sql = "SELECT * FROM donnee2 WHERE Nom LIKE '%$searchkey%' OR Studio LIKE '%$searchkey%' OR Univ LIKE '%$searchkey%'";
              }else{
              $sql = "SELECT * FROM donnee2";
              }
...
<footer class="navbar navbar-inverse" style="margin-top: -20px;">
    <center><p style="margin-left: 60px;margin-top:15px;color: grey;cursor: pointer;"> Liste des locataires en bâtiment B</p></center>
</footer>
