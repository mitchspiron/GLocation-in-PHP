    ...
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header" style="background: #004d80;">
                ...
                <center><h4 class="modal-title" id="myModalLabel" style="color: white;">Formulaire des nouveaux adhérants</h4></center>
            </div>
            ...
            <form method="POST" action="add.php">
                        ...
                        <input class="w3-input w3-border w3-round-large" name="Naissance" type="date">
                        ...
                        <label class="w3-label w3-left">Studio occupé</label>
                        <input class="w3-input w3-border w3-round-large" name="Studio" type="text" placeholder="Studio">
