...
<nav class="navbar navbar-inverse">
        <div class="container-fluid">
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="active"><a href="#"><span class="glyphicon glyphicon-time"></span> Attentes</a></li>
          ...
          <tr>
            <?php
              ...
              if(isset($_POST['search'])){
                ...
                $sql = "SELECT * FROM attentes WHERE Nom LIKE '%$searchkey%' OR Univ LIKE '%$searchkey%'";
              }else{
              $sql = "SELECT * FROM attentes";
              }
...
<footer class="navbar navbar-inverse" style="margin-top: -20px;">
    <center><p style="margin-left: 60px;margin-top:15px;color: grey;cursor: pointer;"> Liste d'attentes</p></center>
</footer>
